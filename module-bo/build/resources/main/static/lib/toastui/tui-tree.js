...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object") module.exports = factory(require("tui-context-menu"));
  else if (typeof define === "function" && define.amd) define(["tui-context-menu"], factory);
  else if (typeof exports === "object") exports["Tree"] = factory(require("tui-context-menu"));
  else (root["tui"] = root["tui"] || {}), (root["tui"]["Tree"] = factory(root["tui"]["ContextMenu"]));
    ...
    /******/ [
      ...
      /***/ function (module, exports) {
        ...
        module.exports = {
          ...
          template: {
            internalNode: '<div class="tui-tree-content-wrapper">' + '<button type="button" class="tui-tree-toggle-btn {{toggleBtnClass}}">' + '<span class="tui-ico-tree"></span>' + "{{stateLabel}}" + "</button>" + '<span class="tui-tree-text {{textClass}}">' + '<span class="tui-tree-ico tui-ico-folder"></span>' + "{{text}}" + "</span>" + "</div>" + '<ul class="tui-tree-subtree {{subtreeClass}}">{{children}}</ul>',
            leafNode: '<div class="tui-tree-content-wrapper">' + '<span class="tui-tree-text {{textClass}}">' + '<span class="tui-tree-ico tui-ico-file"></span>' + "{{text}}" + "</span>" + "</div>",
          },
        ...
        var Draggable = defineClass(
          /** @lends Draggable.prototype */ {
            ...
            _isContain: function (targetPos, mousePos) {
              ...
              return targetPos.left < mousePosX && targetPos.right > mousePosX && top < mousePosY && bottom > mousePosY;
            },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var API_LIST = ["check", "uncheck", "toggleCheck", "isChecked", "isIndeterminate", "isUnchecked", "getCheckedList", "getTopCheckedList", "getBottomCheckedList"];
